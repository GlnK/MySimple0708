...
import com.glen.mysdk.core.AdParameters;
import com.glen.mysimple.R;
import com.glen.mysimple.activity.base.BaseActivity;
import com.glen.mysimple.db.SPManager;
import com.glen.mysdk.constant.SDKConstant.AutoPlaySetting;

/**
 * Created by Gln on 2017/7/5.
 */
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private CheckBox mAlwayBox;
    private CheckBox mNeverBox;
    ...
    private void initView() {
        ...
        int currentSetting = SPManager
                .getInstance().getInt(SPManager.VIDEO_PLAY_SETTING, 1);
