...
import com.glen.mysdk.R;
import com.glen.mysdk.activity.AdBrowserActivity;
import com.glen.mysdk.adutil.LogUtils;
import com.glen.mysdk.adutil.Utils;
import com.glen.mysdk.constant.SDKConstant;
import com.glen.mysdk.core.video.VideoAdSlot;
import com.glen.mysdk.core.video.VideoAdSlot.AdSDKSlotListener;
import com.glen.mysdk.module.AdValue;
import com.glen.mysdk.report.ReportManager;
...
public class VideoFullDialog extends Dialog implements CustomVideoView.ADVideoPlayerListener {
    ...
    public VideoFullDialog(Context context, CustomVideoView mraidView, AdValue instance,
                           int position) {
        super(context, R.style.dialog_full_screen);//通过style的设置，保证全屏
        mContext = context;
